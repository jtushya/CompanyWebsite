...
import { Zap, Database, Cloud, Settings, ArrowRight, CheckCircle } from 'lucide-react';
...
const DigitalTransformation = () => {
  ...
  return (
    <>
      <SEOHead 
        title="Digital Transformation Services | Planckk Technologies"
        description="Transform your business with our comprehensive digital transformation services. Cloud migration, process automation, and data analytics solutions."
        schema={schema}
        breadcrumbs={[
          { name: 'Home', item: '/' },
          { name: 'Services', item: '/services' },
          { name: 'Digital Transformation', item: '/services/digital-transformation' }
        ]}
      />
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              {[
                { number: '01', title: 'Assess', description: 'Digital readiness evaluation' },
                { number: '02', title: 'Plan', description: 'Strategy development' },
                { number: '03', title: 'Transform', description: 'Implementation' },
                { number: '04', title: 'Optimize', description: 'Continuous improvement' },
              ].map((step, index) => (
                <motion.div
                  key={step.number}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                },
                {
                  ...
                  result: "70% improvement in efficiency"
                }
              ].map((study, index) => (
                <motion.div
                  key={index}
