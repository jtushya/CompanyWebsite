...
import { Smartphone, Zap, Shield, Cloud, ArrowRight } from 'lucide-react';
...
const MobileAppDevelopment = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Efficient development for multiple platforms using React Native.'
    },
    {
  ...
  const schema = {
    ...
    "description": "Professional mobile app development services for iOS and Android",
      ...
      "itemListElement": [
        {
          ...
          "itemOffered": {
            ...
            "description": "Custom mobile application development for all platforms"
          }
        }
      ]
    }
  ...
  return (
    <>
      <SEOHead 
        title="Mobile App Development Services | Planckk Technologies"
        description="Transform your ideas into powerful mobile applications. Native and cross-platform development for iOS and Android."
        schema={schema}
        breadcrumbs={[
          { name: 'Home', item: '/' },
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              {[
                { number: '01', title: 'Plan', description: 'Requirements gathering' },
                { number: '02', title: 'Design', description: 'UI/UX design' },
                { number: '03', title: 'Develop', description: 'App development' },
