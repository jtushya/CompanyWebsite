...
import { Share2, Users, BarChart, MessageSquare, ArrowRight, CheckCircle } from 'lucide-react';
...
const SocialMediaManagement = () => {
  ...
  const features = [
    {
      ...
      description: 'Build and engage with your social media community effectively.'
    },
    {
      icon: <BarChart className="h-8 w-8" />,
      title: 'Analytics & Reporting',
      description: 'Detailed insights and performance tracking for all platforms.'
    },
    {
    ...
    },
    {
      ...
      description: 'Coordinated presence across all major social networks.'
    }
  ];
      ...
      "itemListElement": [
        {
          ...
          "itemOffered": {
            ...
            "description": "Complete social media management and strategy solutions"
          }
        }
      ]
    }
  ...
  return (
    <>
      <SEOHead 
        title="Social Media Management Services | Planckk Technologies"
        description="Transform your social media presence with our professional management services. Content creation, community engagement, and performance analytics."
        schema={schema}
        breadcrumbs={[
          { name: 'Home', item: '/' },
          { name: 'Services', item: '/services' },
          { name: 'Social Media Management', item: '/services/social-media' }
        ]}
      />
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              {[
                { number: '01', title: 'Analyze', description: 'Audit current presence' },
                { number: '02', title: 'Plan', description: 'Create content strategy' },
                { number: '03', title: 'Execute', description: 'Implement and engage' },
                { number: '04', title: 'Monitor', description: 'Track and optimize' },
              ].map((step, index) => (
                <motion.div
                  key={step.number}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 mt-4">
                Comprehensive management across all major social networks
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                {
                  ...
                  description: "Engage your community and build brand awareness"
                },
                {
                  name: "Instagram",
                ...
                {
                  name: "LinkedIn",
                  image: "https://images.unsplash.com/photo-1611162616677-f0d0f3d4b306?w=400&h=300&fit=crop",
                  description: "Professional networking and B2B engagement"
                },
                {
                  name: "Twitter",
                  image: "https://images.unsplash.com/photo-1611162616988-b39a2ec055fb?w=400&h=300&fit=crop",
